...
public class Memorando extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/inter/view/imagens/arrows-2.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(jTextField1.getText().trim().equals("")){ 
            ...
            docente.setSuap(Integer.parseInt(jTextField1.getText()));
            try {
                for (Docente u : dd.read2(docente)) {
                    model.addRow(new Object[]{
                        u.getName(),
                        u.getPermissao()
