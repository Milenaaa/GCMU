 ...
 * @author Milena
 */
public class DevolucaoMaterial extends javax.swing.JFrame {

    /**
     * Creates new form DevolucaoMaterial
     */
    public DevolucaoMaterial() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Devolver Material");
        ...
        btRemover3.setForeground(new java.awt.Color(0, 102, 153));
        btRemover3.setText("Devolver");
        ...
        btRemover4.setForeground(new java.awt.Color(0, 102, 153));
        btRemover4.setText("Devolver");
    ...
    private void btRemover3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemover3ActionPerformed
        ...
        try {
            discenteReservaMaterialDAO.delete(Integer.parseInt(TxtMatricula.getText()));
    ...
    private void btRemover4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemover4ActionPerformed
        ...
        try {
            docenteReservaMaterialdao.delete(Integer.parseInt(TxtSuap.getText()));
        } catch (SQLException ex) {
            Logger.getLogger(DevolucaoChave.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DevolucaoMaterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DevolucaoMaterial().setVisible(true);
            }
        });
    }
